                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-slate-700 mt-2">
                      Building AI-powered web applications with React, Next.js, and TypeScript to help businesses automate processes. 
                  ...
                  <div>
                    ...
                    <p className="text-slate-700 mt-2">
                      Full stack React/Next.js/TypeScript community platform for pet sitting, built with transparency and trust. 
                  ...
                  <div>
                    ...
                    <p className="text-slate-700 mt-2">
                      React/Next.js/TypeScript AI travel planning tool with OpenAI integration. Creates personalized journeys 
